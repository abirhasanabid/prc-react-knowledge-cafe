...
const Blog = ({ blog,handlerBookmark,handleReadTime }) => {
    // console.log(blog);
    ...
    return (
        <div className="mb-10 space-y-5">
            ...
            <button className='font-semibold text-[#6047EC] underline' onClick={()=>handleReadTime(read_time)}>Mark as read</button>
        </div>
    );
};
